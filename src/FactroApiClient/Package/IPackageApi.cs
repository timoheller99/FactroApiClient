namespace FactroApiClient.Package
{
    ...
    public interface IPackageApi
    {
        ...
        public Task MoveToProjectAsync(string projectId, string packageId, SetProjectAssociationRequest setPackageAssociationRequest);
        ...
        // Access Rights
        public Task<GetPackageReadRightsResponse> GetReadRightsAsync(string projectId, string packageId);
