namespace FactroApiClient.UnitTests.ProjectApi
{
    ...
    public partial class ProjectApiTests
    {
        ...
        public async Task CreateProjectComment_BadRequest_ShouldReturnProjectApiException()
        {
            ...
            var createProjectResponse = new CreateProjectCommentResponse();

            // Act
            Func<Task> act = async () => createProjectResponse = await projectApi.CreateProjectCommentAsync(Guid.NewGuid().ToString(), createProjectRequest);
