namespace FactroApiClient.UnitTests.ProjectApi
{
    ...
    {
        [Fact]
        public async Task RevokeProjectWriteRightsFromUserAsync_ValidRequest_ShouldReturnVoid()
        {
            // Arrange
        ...
        public async Task RevokeProjectWriteRightsFromUserAsync_InvalidProjectId_ShouldThrowArgumentNullException(string projectId)
        {
            // Arrange
            var employeeId = Guid.NewGuid().ToString();
            ...
            // Act
            Func<Task> act = async () => await projectApi.RevokeProjectWriteRightsFromUserAsync(projectId, employeeId);
        ...
        public async Task RevokeProjectWriteRightsFromUserAsync_BadRequest_ShouldThrowProjectApiException()
        {
            // Arrange
