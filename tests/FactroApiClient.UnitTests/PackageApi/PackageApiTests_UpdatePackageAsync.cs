namespace FactroApiClient.UnitTests.PackageApi
{
    ...
    public partial class PackageApiTests
    {
        ...
        public async Task UpdatePackageAsync_ValidRequest_ShouldReturnUpdatePackage()
        {
            ...
            // Act
            Func<Task> act = async () =>
                updatePackageResponse = await projectApi.UpdatePackageAsync(existingProject.Id, existingPackage.Id, updatePackageRequest);
        ...
        public async Task UpdatePackageAsync_InvalidProjectId_ShouldThrowArgumentNullException(string projectId)
        {
            ...
            // Act
            Func<Task> act = async () => await projectApi.UpdatePackageAsync(projectId, existingPackage.Id, updatePackageRequest);
        ...
        public async Task UpdatePackageAsync_InvalidPackageId_ShouldThrowArgumentNullException(string packageId)
        {
            ...
            // Act
            Func<Task> act = async () => await projectApi.UpdatePackageAsync(existingProject.Id, packageId, updatePackageRequest);
        ...
        public async Task UpdatePackageAsync_NullRequestModel_ShouldThrowArgumentNullException()
        {
            ...
            // Act
            Func<Task> act = async () => await projectApi.UpdatePackageAsync(existingProject.Id, existingPackage.Id, updatePackageRequest: null);
        ...
        public async Task UpdatePackageAsync_UnsuccessfulRequest_ShouldThrowFactroApiException()
        {
            ...
            // Act
            Func<Task> act = async () => await projectApi.UpdatePackageAsync(projectId, packageId, updateProjectRequest);
